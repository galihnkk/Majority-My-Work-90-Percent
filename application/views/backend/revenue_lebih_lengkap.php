          ...
          <div class="grid grid-cols-12 gap-4 md:gap-6 2xl:gap-9">
            <div class="col-span-12 rounded-sm border border-stroke bg-white px-5 pb-5 pt-7.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5">
              ...
              <?php foreach ($revenue_per_year as $year => $months): ?>
                ...
                <div>
                  <span>Gross Revenue (Paid): Rp <?= number_format(array_sum(array_column($months, 'total_paid')), 0, ',', '.') ?></span>
                  <span> | Pending Revenue (Unpaid): Rp <?= number_format(array_sum(array_column($months, 'total_unpaid')), 0, ',', '.') ?></span>
                  </div><br>
